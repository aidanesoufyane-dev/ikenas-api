...
router.get('/student/me/space', protect, roleCheck('student'), getStudentPaymentSpace);
router.get('/student/me/invoices/:paymentId', protect, roleCheck('student'), getStudentInvoiceDetail);
router.get('/student/me/invoices/:paymentId/download', protect, roleCheck('student'), downloadInvoice);
router.get('/student/me/receipts/:paymentId/download', protect, roleCheck('student'), downloadReceipt);
