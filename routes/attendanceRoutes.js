...
router.get('/me', protect, roleCheck('student'), getMyAttendances);
router.put('/:id/justify', protect, roleCheck('student'), uploadAttendanceJustification.single('attachment'), justifyAttendance);
